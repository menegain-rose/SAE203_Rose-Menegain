        ...
        animate-fadeInRight"
            :class="{ 'translate-x-0': menuOuvert }" v-if="menuOuvert">
              <div class="flex-col text-black text-center text-3xl my-40">
                ...
                <button class="z-50 absolute top-6 right-8" aria-haspopup="true" aria-controls="menu" 
                    :aria-expanded="menuOuvert" @click="menuOuvert = !menuOuvert">
                    <svg class="absolute" v-if="!menuOuvert" width="25" height="25" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path fill="url(#pattern0)" d="M0 0h49v49H0z"/><defs><pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1"><use xlink:href="#image0_1004_881" transform="scale(.00195)"/></pattern><image id="image0_1004_881" width="512" height="512" xlink:href="data:image/png;base64,"/></defs></svg>
                ...
                <RouterLink to="/Billeterie" @click="menuOuvert = !menuOuvert">
                  <div class="h-24 p-3 text-PrincipalyText justify-around ">
